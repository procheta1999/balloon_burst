...
gameScene.create = function () {
  ...
  this.add.image(120, 120, 'ball'); // this.ball=this.add.sprite(150,180,'ball',{align:"center"});
  // this.ball.setScale(1.3,1.3);
...
window.onload = function () {
  ...
  var game = new Phaser.Game(config); // this.scene.start('background');
